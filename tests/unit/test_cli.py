...
class TestCLIArguments:
    ...
    def test_nonexistent_input_file(self, runner, temp_dir):
        """Should error for non-existent file."""
        fake_path = str(temp_dir / "nonexistent.mp4")
        result = runner.invoke(main, [fake_path])
    ...
    def test_device_choices(self, runner, temp_dir):
        ...
        result = runner.invoke(main, [str(dummy_file), "--device", "invalid"])
...
class TestCLIIntegration:
    ...
    def test_diarization_warning_without_token(self, runner, temp_dir):
    ...
    def test_no_diarization_flag(self, runner, temp_dir):
        ...
        with patch("scribbulus.cli.transcribe.TranscriptionEngine") as mock_engine:
            ...
            result = runner.invoke(main, [str(dummy_file), "--no-diarization"])
...
class TestErrorHandling:
    ...
    def test_unsupported_format_error(self, runner, temp_dir):
    ...
    def test_keyboard_interrupt_handled(self, runner, temp_dir):
